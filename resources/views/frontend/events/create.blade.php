                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.events.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_event" id="nama_event" value="{{ old('nama_event', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_code" id="event_code" value="{{ old('event_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="tanggal_mulai" id="tanggal_mulai" value="{{ old('tanggal_mulai') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai') }}">
