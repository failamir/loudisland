...
<head>
    ...
    <style>
        ...
        /* Remove top spacing for marathon slider */
        body,
        html {
            margin: 0 !important;
            padding: 0 !important;
...
<body id="home">
    ...
    <!-- ============== PRELOADER END ============== -->
    <!-- <span class="bg-effect"
        style="background-image: url('{{ asset('assets/img/main-bg.svg') }}'); position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: -1;"></span> -->
    <!-- ================= HEADER ================= -->
        ...
        <div class="header-nav">
            <div class="container">
                <div class="header-nav-cover">
                    ...
                    <a href="{{ 'https://daftar.mandalikakorprirun.com' }}" class="btn btn-white"><span>registration</span></a>
                </div>
            </div>
        </div>
    </header> -->
        ...
        <section class="s-marathon-slider"
            ...
            <div class="marathon-slider">
                ...
                <div data-hover-only="true" data-pointer-events="true" data-scalar-y="0" class="scene">
                    ...
                    <div class="scene-item" data-depth="0.2">
                        <img class="marathon-img" style="width: 50%;" src="{{ asset('giner-assets/img/cowo1.png') }}" alt="img">
                    </div>
                    <div class="scene-item" data-depth="0.5">
                        <div class="slider-location">Mandalika <br>Fun Run <span class="date">6 Desember 2025</span>
                        </div>
                ...
                <div data-hover-only="true" data-pointer-events="true" data-scalar-y="0" class="scene">
                    ...
                    <div class="scene-item" data-depth="0.2">
                        <img class="marathon-img" style="width: 50%;" src="{{ asset('giner-assets/img/cowo2.png') }}" alt="img">
                    </div>
                    <div class="scene-item" data-depth="0.5">
                        <div class="slider-location">Mandalika <br>Fun Run <span class="date">6 Desember 2025</span>
                        </div>
