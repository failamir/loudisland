...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('giner-assets/img/favicon.png') }}">
    <!-- =================== STYLE =================== -->
    <link rel="stylesheet" type="text/css" href="{{ asset('giner-assets/css/slick.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('giner-assets/css/bootstrap-grid.css') }}">
    <link href="https://use.fontawesome.com/releases/v5.10.1/css/all.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('giner-assets/css/nice-select.css') }}">
...
<body id="home">
                    ...
                    <nav class="nav-menu menu">
                        <ul class="nav-list">
                            <li class="dropdown active-page">
                                ...
                                <ul>
                                    <li class="active-page"><a href="{{ url('/') }}">Home Marathon</a></li>
                                    <li><a href="conference-page.html">Home Conference</a></li>
                                    <li><a href="dance-page.html">Home Dance</a></li>
                                </ul>
                            </li>
    ...
    <section class="s-marathon-slider">
        <div class="marathon-slider">
                ...
                <div data-hover-only="true" data-pointer-events="true" data-scalar-y="0" class="scene">
                    <div class="scene-item" data-depth="0.2">
                        <span class="marathon-effect"
                            style="background-image: url('{{ asset('assets/img/effect-slider-marathon.svg') }}');"></span>
                    </div>
                    <div class="scene-item" data-depth="0.2">
                        <img class="marathon-img" src="{{ asset('giner-assets/img/slider-1.png') }}" alt="img">
                    </div>
                    <div class="scene-item" data-depth="0.5">
                        <div class="slider-location">San Francisco <br>marathon <span class="date">27 dec 2019</span>
                        </div>
                    </div>
            ...
            <div class="marathon-slide marathon-slide-2">
                <div data-hover-only="true" data-pointer-events="true" data-scalar-y="0" class="scene">
                    ...
                    <div class="scene-item" data-depth="0.2">
                        <img class="marathon-img" src="{{ asset('giner-assets/img/slider-2.png') }}" alt="img">
                    </div>
                    <div class="scene-item" data-depth="0.5">
                        <div class="slider-location">San Francisco <br>marathon <span class="date">27 dec
                                2019</span>
                        </div>
                    </div>
                    <div class="scene-item" data-depth="0.35">
            ...
            <div class="marathon-slide marathon-slide-3">
                <div data-hover-only="true" data-pointer-events="true" data-scalar-y="0" class="scene">
                    ...
                    <div class="scene-item" data-depth="0.2">
                        <img class="marathon-img" src="{{ asset('giner-assets/img/slider-3.png') }}" alt="img">
                    </div>
                    <div class="scene-item" data-depth="0.5">
                        <div class="slider-location">San Francisco <br>marathon <span class="date">27 dec
                                2019</span>
        ...
        <img class="marathon-slider-shape" src="{{ asset('giner-assets/img/slider-home1-shape.svg') }}" alt="shape">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 our-mission-img">
                    <span>
                        <img class="mission-img-effect-1" src="{{ asset('giner-assets/img/our-mission-2.svg') }}" alt="img">
                        <img class="mission-img rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                            data-src="{{ asset('giner-assets/img/our-mission.jpg') }}" alt="img">
                        <img class="mission-img-effect-4" src="{{ asset('giner-assets/img/tringle-gray-little.svg') }}"
                            alt="img">
                    </span>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3 choose-us-item">
                    <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                        data-src="{{ asset('giner-assets/img/icon-1.svg') }}" alt="img">
                    <h4>Quick registration</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing</p>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 choose-us-item">
                    <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                        data-src="{{ asset('giner-assets/img/icon-2.svg') }}" alt="img">
                    <h4>Delivery to the venue</h4>
                    <p>Voluptatibus molestiae aperiam ducimus, architecto</p>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 choose-us-item">
                    <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                        data-src="{{ asset('giner-assets/img/icon-3.svg') }}" alt="img">
                    <h4>Water for participants</h4>
                    <p>cumque odio dolorum expedita ea illo sit laboriosam</p>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 choose-us-item">
                    <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                        data-src="{{ asset('giner-assets/img/icon-4.svg') }}" alt="img">
                    <h4>Medical staff</h4>
    ...
    <section id="schedule" class="s-event-schedule">
        <div class="container">
            ...
            <img class="schedule-effect-yellow" src="{{ asset('giner-assets/img/tringle-yellow-little.svg') }}" alt="img">
            <div class="row">
                <div class="col-xl-6">
                    <div class="event-schedule-tabs">
                        <div class="event-schedule-item">
                            <div class="schedule-item-img">
                                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                                    data-src="{{ asset('giner-assets/img/event-icon-1.svg') }}" alt="img">
                            </div>
                        ...
                        <div class="event-schedule-item">
                            <div class="schedule-item-img"><img class="rx-lazy"
                                    src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                                    data-src="{{ asset('giner-assets/img/event-icon-2.svg') }}" alt="img"></div>
                            <div class="schedule-item-info">
                        ...
                        <div class="event-schedule-item">
                            <div class="schedule-item-img"><img class="rx-lazy"
                                    src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                                    data-src="{{ asset('giner-assets/img/event-icon-3.svg') }}" alt="img"></div>
                            <div class="schedule-item-info">
                        ...
                        <div class="event-schedule-item">
                            <div class="schedule-item-img"><img class="rx-lazy"
                                    src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                                    data-src="{{ asset('giner-assets/img/event-icon-4.svg') }}" alt="img"></div>
                            <div class="schedule-item-info">
                ...
                <div class="col-md-6 event-schedule-img">
                    <div class="schedule-img-wrap">
                        <img class="schedule-effect-tringle" src="{{ asset('giner-assets/img/tringle-gray-little.svg') }}"
                            alt="img">
                        <img class="schedule-img-effect" src="{{ asset('giner-assets/img/our-mission-2.svg') }}" alt="img">
                        <img class="schedule-img rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                            data-src="{{ asset('giner-assets/img/event-schedule.jpg') }}" alt="img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 map-route-img">
                    <span>
                        <img src="{{ asset('giner-assets/img/our-mission-2.svg') }}" alt="img" class="map-img-effect-1">
                        <img src="{{ asset('giner-assets/img/tringle-gray-little.svg') }}" alt="img" class="map-img-effect-2">
                        <img class="rx-lazy map-img" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                            data-src="{{ asset('giner-assets/img/map.png') }}" alt="img">
                    </span>
                </div>
                    ...
                    <div class="map-route-cover">
                        ...
                        <div class="route-info-content">
                            <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                                voluptatum deleniti atque corrupti quos dolores et quas. At vero eos et accusamus et
                                iusto.</p>
                        </div>
                        <div class="mission-number-cover">
                            <div class="mission-number-item">
                                <img src="{{ asset('giner-assets/img/map-effect.svg') }}" alt="img" class="map-img-effect">
                                <div class="number">42,4km</div>
                                <span>Run distance</span>
                            </div>
                        </div>
    ...
    <section id="register" class="s-marathon-register">
        ...
        <div class="container">
            <div class="marathon-register-row">
                <img src="{{ asset('giner-assets/img/placeholder-all.png') }}" data-src="{{ asset('giner-assets/img/register-img.png') }}"
                    alt="img" class="register-img rx-lazy">
                <div class="marathon-register">
                    <img src="{{ asset('giner-assets/img/our-mission-2.svg') }}" alt="img" class="register-img-effect-1">
                    <h2 class="title"><span>Register form</span></h2>
                    <form id='contactform' action="giner-assets/php/contact.php" name="contactform">
                        <ul class="form-cover">
            ...
            <div class="clients-cover">
                <div class="client-slide">
                    <div class="client-slide-cover">
                        <img src="{{ asset('giner-assets/img/client-1.svg') }}" alt="img">
                    </div>
                </div>
                <div class="client-slide">
                    <div class="client-slide-cover">
                        <img src="{{ asset('giner-assets/img/client-2.svg') }}" alt="img">
                    </div>
                </div>
                <div class="client-slide">
                    <div class="client-slide-cover">
                        <img src="{{ asset('giner-assets/img/client-4.svg') }}" alt="img">
                    </div>
                </div>
                <div class="client-slide">
                    <div class="client-slide-cover">
                        <img src="{{ asset('giner-assets/img/client-5.svg') }}" alt="img">
                    </div>
                </div>
                <div class="client-slide">
                    <div class="client-slide-cover">
                        <img src="{{ asset('giner-assets/img/client-6.svg') }}" alt="img">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="marathon-news-slider">
                <div class="marathon-news-slide">
                    ...
                    <div class="marathon-news-item">
                        ...
                        <div class="marathon-post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('giner-assets/img/post-1-home-1.jpg') }}"
                                    alt="img"></a>
                        </div>
                ...
                <div class="marathon-news-slide">
                    ...
                    <div class="marathon-news-item">
                        ...
                        <div class="marathon-post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('giner-assets/img/post-2-home-1.jpg') }}"
                                    alt="img"></a>
                        </div>
                        <div class="marathon-post-content">
                ...
                <div class="marathon-news-slide">
                    ...
                    <div class="marathon-news-item">
                        ...
                        <div class="marathon-post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('giner-assets/img/post-3-home-1.jpg') }}"
                                    alt="img"></a>
                        </div>
                        <div class="marathon-post-content">
                ...
                <div class="marathon-news-slide">
                    ...
                    <div class="marathon-news-item">
                        ...
                        <div class="marathon-post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('giner-assets/img/post-4-home-1.jpg') }}"
                                    alt="img"></a>
                        </div>
                        <div class="marathon-post-content">
                ...
                <div class="marathon-news-slide">
                    ...
                    <div class="marathon-news-item">
                        ...
                        <div class="marathon-post-thumbnail">
                            <a href="single-blog.html"><img src="{{ asset('giner-assets/img/post-5-home-1.jpg') }}"
                                    alt="img"></a>
                        </div>
                        <div class="marathon-post-content">
    ...
    <section class="s-instagram">
        <div class="instagram-cover">
            <a href="#" class="instagram-item">
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-1.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-2.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-3.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-4.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-5.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                    <li class="comments">350 <i class="far fa-comment"></i></li>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-6.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                    <li class="comments">350 <i class="far fa-comment"></i></li>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-7.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                    <li class="comments">350 <i class="far fa-comment"></i></li>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-8.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                    <li class="comments">350 <i class="far fa-comment"></i></li>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-9.jpg') }}" alt="img">
            </a>
            <a href="#" class="instagram-item">
                <ul>
                    <li class="comments">350 <i class="far fa-comment"></i></li>
                ...
                <img class="rx-lazy" src="{{ asset('giner-assets/img/placeholder-all.png') }}"
                    data-src="{{ asset('giner-assets/img/instagram-10.jpg') }}" alt="img">
            </a>
        </div>
    </section>
    <!--================ S-INSTAGRAM END ================-->
        ...
        <div class="container">
            <div class="row">
                <div class="footer-cont col-12 col-sm-6 col-lg-4">
                    <a href="{{ url('/') }}" class="logo"><img src="{{ asset('giner-assets/img/logo.svg') }}" alt="logo"></a>
