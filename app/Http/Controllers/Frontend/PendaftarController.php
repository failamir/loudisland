...
class PendaftarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.pendaftars.index', compact('events', 'pendaftars'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.pendaftars.create', compact('events'));
    }
    ...
    public function edit(Pendaftar $pendaftar)
    {
        ...
        return view('frontend.pendaftars.edit', compact('events', 'pendaftar'));
    }
